...
lang = Tk()
lang.title("Choose your language to display.")
lang.iconbitmap('GOL_cui.ico')
lang_title = Label(lang, text="Pick the language：")
...
chinese = Button(lang, text="简体中文",command=choose_cn)
english = Button(lang, text="English",command=choose_en)
